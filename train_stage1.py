...
from network.model_stage1 import MedDisSeg1
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join("run_files_1_Disloss_1_infonce_l2-weight=0.2 T=0.1", dataset_name,folder_name)
    ...
    # model = ConDSegStage1()
    model = MedDisSeg1(use_dispersive_loss=True, dispersive_config={
